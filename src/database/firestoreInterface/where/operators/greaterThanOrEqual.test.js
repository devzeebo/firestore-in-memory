...
describe('where greater than or equal', () => {
  test('number greater than returns TRUE', {
    given: {
  ...
  test('number less than returns FALSE', {
    given: {
...
function data_value_GREATER_THAN_query_value() {
  this.func = greaterThanOrEqual(5);
  this.data_value = 10;
}
function data_value_LESS_THAN_query_value() {
  this.func = greaterThanOrEqual(10);
  this.data_value = 5;
}
...
function word_data_value_GREATER_THAN_query_value() {
  this.func = greaterThanOrEqual('cat');
  this.data_value = 'dog';
}
function word_data_value_LESS_THAN_query_value() {
  this.func = greaterThanOrEqual('dog');
  this.data_value = 'cat';
}
